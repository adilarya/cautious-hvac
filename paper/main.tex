...
chosen reward shape, a diagnosed reward-shaping failure mode rather
than a fundamental RL limitation. A controlled ablation over the
...
structure rather than the proposed cautious term. All experiments are reproducible with a single command at five
